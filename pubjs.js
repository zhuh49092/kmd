   ...
   var detailData;   
    ...
    const SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbynSeLQkhbb2iGCOJeYKEP7-K6HGjo6sahMwYApNRuaVa3cHe5jXsuFoFGlPkrqiezN6Q/exec';
          ...
          var datas={
	            ...
	            try {
	                  postData('save',datas,function(data){
	                  	...
	                  	addNewCard(datas) ;
	                  	setTimeout(() => {hideModal("#modalOverlay");
	                  	startAnimation(3);
					            launchConfetti();
	                  		},500);					                  	 	  
	                  });                              					                  
            ...
            img.onload = function() {
              ...
              let fileSize = (file.size / 320).toFixed(1);
					    ...
					    if (displayHeight > 320) {
					        ...
					        displayHeight = 320;
					        displayWidth = Math.round(320 * ratio);
					    }  
...
$(document).ready(function() {
    ...
    if (sessionStorage.getItem('krefreshed_'+_id) === 'true') {       
    } else {
        sessionStorage.setItem('krefreshed_'+_id, 'true');
         ViewCard(_id);
         startAnimation(1);
    }
});
